...
export function SellerDashboard(){
  ...
  useEffect(() => {
    ...
    setReviews([
      { id: 1, rating: 4.9, text: 'Great service!' },
      { id: 2, rating: 4.9, text: 'Fast delivery!' },
      { id: 3, rating: 4.9, text: 'Quality products!' },
    ]);
          ...
          <div className="d-flex justify-content-between mt-3">
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="rounded bg-secondary" style={{ height: 60, marginBottom: 10 }}></div>
                <div className="d-flex justify-content-between align-items-center">
                  <div>
                    {review.rating} <span style={{ color: '#FE7743' }}>★★★★☆</span>
                  </div>
                  <div>↻</div>
                </div>
              </div>
